...
public class TablelistAdapter1 extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.dateTextView.setText(mvddateObject==null?"":mvddateObject.toString().substring(0, 10));
		
		Object mslObject = map.get(DataBaseHelper.MSL);
		holder.numTextView.setText(mslObject==null?"":DecimalsHelper.Transfloat(Double.parseDouble(mslObject.toString()),MyApplication.getInstance().getNumPoint()));
		
		Object djObject = map.get(DataBaseHelper.DJ);
		holder.djTextView.setText(djObject==null?"":DecimalsHelper.Transfloat(Double.parseDouble(djObject.toString()),MyApplication.getInstance().getDjPoint()));
		
		Object zjObject = map.get(DataBaseHelper.ZJ);
		holder.zjTextView.setText(zjObject==null?"":DecimalsHelper.Transfloat(Double.parseDouble(zjObject.toString()),MyApplication.getInstance().getJePoint()));
		...
		holder.kcTextView.setText(azkcObject==null?"":DecimalsHelper.Transfloat(Double.parseDouble(azkcObject.toString()),MyApplication.getInstance().getNumPoint()));
		...
		if(map.get("click_Color")!=null && (Boolean) map.get("click_Color")){
