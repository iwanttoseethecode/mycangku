...
public class DataBaseMethod {
	...
	public void Addhp1(int id, String hpmc, String hpbm, String txm, String gg,
			...
			int type, String gxtime, String imgpath,String yxq) {
...
//				+ DataBaseHelper.ImagePath + ",yxq ) values ('" + id + "','" + hpmc
//				+ "','" + hpbm + "','" + txm + "','" + gg + "','" + dw + "','"
//				+ dw2 + "','" + bignum + "','" + kc + "','" + kcje + "','"
//				+ sccs + "','" + sx + "','" + xx + "','" + rkckj + "','"
...
//				+ type + "','" + gxtime + "','" + imgpath +"','"+yxq+ "')");
		
		
		ContentValues contentvalues = new ContentValues();
		contentvalues.put(DataBaseHelper.ID, id);
		contentvalues.put(DataBaseHelper.HPMC, hpmc);
		contentvalues.put(DataBaseHelper.HPBM, hpbm);
		contentvalues.put(DataBaseHelper.HPTM, txm);
		contentvalues.put(DataBaseHelper.GGXH, gg);
		contentvalues.put(DataBaseHelper.JLDW, dw);
		contentvalues.put(DataBaseHelper.JLDW2, dw2);
		contentvalues.put(DataBaseHelper.BigNum, bignum);
		contentvalues.put(DataBaseHelper.CurrKC, kc);
		contentvalues.put(DataBaseHelper.KCJE, kcje);
		contentvalues.put(DataBaseHelper.SCCS, sccs);
		contentvalues.put(DataBaseHelper.HPSX, sx);
		contentvalues.put(DataBaseHelper.HPXX, xx);
		contentvalues.put(DataBaseHelper.RKCKJ, rkckj);
		contentvalues.put(DataBaseHelper.CKCKJ, ckckj);
		contentvalues.put(DataBaseHelper.CKCKJ2, ckckj2);
		contentvalues.put(DataBaseHelper.LBS, lbs);
		contentvalues.put(DataBaseHelper.LBID, lbid);
		contentvalues.put(DataBaseHelper.LBIndex, lbIndex);
		contentvalues.put(DataBaseHelper.BZ, bz);
		contentvalues.put(DataBaseHelper.HPPY, hppy);
		contentvalues.put(DataBaseHelper.StopTag, stop);
		contentvalues.put(DataBaseHelper.RES1, res1);
		contentvalues.put(DataBaseHelper.RES2, res2);
		contentvalues.put(DataBaseHelper.RES3, res3);
		contentvalues.put(DataBaseHelper.RES4, res4);
		contentvalues.put(DataBaseHelper.RES5, res5);
		contentvalues.put(DataBaseHelper.RES6, res6);
		contentvalues.put(DataBaseHelper.RESD1, resd1);
		contentvalues.put(DataBaseHelper.RESD2, resd2);
		contentvalues.put(DataBaseHelper.Type, type);
		contentvalues.put(DataBaseHelper.GXDate, gxtime);
		contentvalues.put(DataBaseHelper.ImagePath, imgpath);
		contentvalues.put(DataBaseHelper.YXQ, yxq);
		db.insert(DataBaseHelper.TB_HP, null, contentvalues);
	...
	public void Addhp(int id, String hpmc, String hpbm, String txm, String gg,
			...
			String hppy, int stop, String res1, String res2, String res3,
			String res4, String res5, String res6, String resd1, String resd2,
			int type, String gxtime, String imgpath,String yxq,String CurrkC) {
...
//				+ type + "','" + gxtime + "','" + imgpath +"','"+yxq+ "')");
		...
		contentvalues.put(DataBaseHelper.ImagePath, imgpath);
		contentvalues.put(DataBaseHelper.YXQ, yxq);
		contentvalues.put(DataBaseHelper.CurrKC, CurrkC);
		db.insert(DataBaseHelper.TB_HP, null, contentvalues);
