...
public class OrderFragment extends Fragment implements OnClickListener{
	...
	private LinearLayout cgorderLayout,xsorderLayout,myorderLayout,historyOrderLayout;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		historyOrderLayout = (LinearLayout) view.findViewById(R.id.historyOrderLayout);
		...
		if(MyApplication.getInstance().getSharedPreferences().getInt(ShareprefenceBean.IS_LOGIN, -1)==1){
			...
			historyOrderLayout.setOnClickListener(this);
	...
	public void onClick(View v) {
		...
		case R.id.myorderLayout:
			...
			startActivity(intent);
			break;
		case R.id.historyOrderLayout:
			if(!RightsHelper.isHaveRight(RightsHelper.dd_cg_showall, MyApplication.getInstance().getSharedPreferences()) || !RightsHelper.isHaveRight(RightsHelper.dd_xs_showall, MyApplication.getInstance().getSharedPreferences())){
				Toast.makeText(context, "你没有查看历史订单的权限", Toast.LENGTH_SHORT).show();
				return;
			}
