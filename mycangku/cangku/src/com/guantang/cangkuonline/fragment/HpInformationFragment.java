...
public class HpInformationFragment extends Fragment implements OnClickListener{
	...
	private TextView modTextView, tiaomaTextView, bianmaTextView,
			...
			res3_text, res4_text, res5_text, res6_text,yxqTxtView;
	...
	private String[] str={DataBaseHelper.ID,DataBaseHelper.HPMC,DataBaseHelper.HPBM,DataBaseHelper.HPTM,DataBaseHelper.GGXH,
			...
			DataBaseHelper.LBS,DataBaseHelper.KCJE,DataBaseHelper.ImagePath,DataBaseHelper.YXQ};
	private String[] str1={"id","HPMC","HPBM","HPTBM","GGXH","CurrKc","JLDW","HPSX","HPXX","SCCS","BZ","RKCKJ","CKCKJ",
			"CKCKJ2","JLDW2","BigNum","res1","res2","res3","res4","res5","res6","LBS","kcje","ImageUrl","yxq"};
	...
	public void initView(){
		...
		yxqTxtView = (TextView) getView().findViewById(R.id.yxqTxtView);
	...
	public void setTextView() {
		...
		if(map.get(DataBaseHelper.CurrKC)!=null && !map.get(DataBaseHelper.CurrKC).toString().equals("")){
		...
		if(map.get(DataBaseHelper.YXQ)!=null && !map.get(DataBaseHelper.YXQ).toString().equals("")){
			String yxq = map.get(DataBaseHelper.YXQ).toString();
			yxqTxtView.setText(yxq);
		}
		...
		if(map.get(DataBaseHelper.RKCKJ)!=null && !map.get(DataBaseHelper.RKCKJ).toString().equals("")){
		...
		if(map.get(DataBaseHelper.CKCKJ)!=null && !map.get(DataBaseHelper.CKCKJ).toString().equals("")){
