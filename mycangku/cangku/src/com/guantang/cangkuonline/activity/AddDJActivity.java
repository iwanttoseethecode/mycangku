...
//	private CheckEditWatcher cked = new CheckEditWatcher();
	...
	private boolean commitflag= true; //true 允许提交，false 不允许提交
	...
	class AddRuKu_2_0AsyncTask extends AsyncTask<String,Void,String>{
		...
		protected void onPostExecute(String result) {
			...
			try {
				...
				case 1:
				case 2:
					dm_op.Update_DJtype(djid, 1);// type 0代表没有保存，1代表上传和保存本地，-1代表保存本地没上传
					...
					builder.setNegativeButton("是", new DialogInterface.OnClickListener() {
						...
						public void onClick(DialogInterface dialog, int which) {
							...
							if(WebserviceImport.isOpenNetwork(AddDJActivity.this)){
								pro_Dialog = ProgressDialog.show(AddDJActivity.this, null, "正在上传数据……");
