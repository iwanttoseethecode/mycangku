...
public class WebHelper extends BaseActivity implements OnClickListener,OnCheckedChangeListener {
...
//				Toast.makeText(WebHelper.this, "仓库信息更新完毕", Toast.LENGTH_SHORT).show();
	...
	private Runnable hpxinxiRunnable = new Runnable() {
		...
		public void run() {
			// TODO 自动生成的方法存根
			Message msg = Message.obtain();
			DataBaseManager dataBaseManager = DataBaseManager.getInstance(WebHelper.this);
