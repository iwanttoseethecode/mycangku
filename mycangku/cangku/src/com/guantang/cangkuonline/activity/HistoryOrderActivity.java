...
import com.guantang.cangkuonline.fragment.HistoryOrderFragment;
...
public class HistoryOrderActivity extends BaseActivity implements OnClickListener {
	...
	public interface DDfilterInterface2{
	...
	public void init(){
		...
		HistoryOrderFragment mAllOrderFragment = HistoryOrderFragment.getInstance("All");
		HistoryOrderFragment mDaiShenHeFragment = HistoryOrderFragment.getInstance("NotAuditedInfo");
		HistoryOrderFragment mDaiZhiXingFragment = HistoryOrderFragment.getInstance("Pending");
		HistoryOrderFragment mBeiBoHuiFragment = HistoryOrderFragment.getInstance("RejectInfo");
		HistoryOrderFragment mFinishOrderFragment = HistoryOrderFragment.getInstance("FinishedInfo");
		...
		if(arg0 == 1){
			if(arg1 == 1){
				...
				for(int i = 0; i<fragmentlist.size();i++){
					 ((DDfilterInterface2) fragmentlist.get(i)).execute(new ObjectNine(sql, sqfromtime, sqtotime));
				}
			}
		}
	}
